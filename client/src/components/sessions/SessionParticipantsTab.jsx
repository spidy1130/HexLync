  ...
  return (
    <div className='space-y-2.5'>
      {participants.map((p,idx)=>{
        ...
        const isHost=Boolean(hostId && participantUserId && participantUserId.toString() 
        === hostId.toString());
        ...
        return (
            ...
            bg-slate-50 border border-slate-100 '>
                <div className='flex items-center gap-3'>
                    ...
                    border-cyan-200 text-primary font-bold flex items-center justify-center text-sm'>
