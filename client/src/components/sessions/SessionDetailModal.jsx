            ...
            <div className='p-6 border-b border-slate-100 flex items-center justify-between '>
                <div>
                    <div className='flex items-center gap-2'>
                        <span className=' text-xs font-mono text-slate-500 font-medium bg-slate-100 px-2 
                        py-0.5 rounded-md'>ID:{session.meetingId}</span>
                ...
                <button onClick={onClose}
                 ...
                 hover:text-slate-700 transition-colors cursor-pointer' aria-label="Close session details">
