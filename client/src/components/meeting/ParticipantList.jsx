...
const ParticipantList = ({isOpen , onClose , localUser , localAudio , localVideo , remoteUsers 
    , meetingHostId}) => {
  ...
  return (
    <aside className='w-full sm:w-80 h-full bg-white border border-slate-200 flex flex-col
    z-30 shadow-2xl animate-in  slide-in-form-right duration-200'>
        {/* header */}
        <div className='p-4 border-b border-slate-200 flex items-center justify-between'>
            <h3 className='font-medium text-slate-900 text-base flex items-center 
            gap-2'>Participants ({allParticipants.length})</h3>
                ...
                return ( 
                    ...
                    border border-slate-200 shadow-xs'>
                        <div className='flex items-center gap-3'>
                            <div className='w-9 h-9 rounded-full bg-primary-light border
                            ...
                            <div className='flex flex-col'>
                                <span className='text-sm font-medium text-slate-800 flez
