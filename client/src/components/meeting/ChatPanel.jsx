  ...
  return (
    ...
    z-30 shadow-2xl animate-in  slide-in-form-right duration-200'>
                ...
                messages.map((msg,index)=>{
                    ...
                    return (
                        <div key={msg.id || index} className={`flex flex-col ${isMe?"items-end":"items-start"}`}>
                            ...
                            <div className={`px-3.5 py-3.5 rounded-2xl max-w-[85%] text-sm
                                leading-relaxed shadow-xs ${isMe?
        ...
        flex items-center gap-2'>
            ...
            focus:border-primary rounded-xl px-3.5 py-2.5 text-sm text-slate-900 placeholder-slate-400
