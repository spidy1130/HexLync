...
const MeetingRoom = () => {
  ...
  return (
    ...
    overflow-hidden relative font-sans'>
      {/* Top Bar */}
      <header className='w-full bg-white/90 backdrop-blur-md px-6 py-3 border-b border-slate-200 flex 
      items-center justify-between z-30 shadow-xs'>
      ...
      {/* Main contents (video grid+side panels) */}
